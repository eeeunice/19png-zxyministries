...
import da.CustomerDC;
import domain.CustomerForget;
...
@WebServlet("/Forgetpass_custs")
public class Forgetpass_cust extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(Forgetpass_cust.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean exists = customerDC.doesEmailExist(email);
