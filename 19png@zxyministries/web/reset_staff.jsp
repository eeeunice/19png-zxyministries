...
<body>
  <div class="overlay">
<form action="${pageContext.request.contextPath}/ResetStaffServlets" method="post">
      <div class="con">
        ...
        <a class="back-link" href="Login_Staff.jsp"><i class="fa fa-arrow-left"></i> Back to Login</a>
      </div>
    </form>
  </div>
</body>
