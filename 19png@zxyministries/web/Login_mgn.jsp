...
<body>
  ...
  <div class="overlay">
    <form action="LoginServletMgn" method="post">
      <div class="con">
...
<div class="other">
  <button class="btn submits" type="button" onclick="location.href='forgot_mgn.jsp'">
    <i class="fa fa-unlock-alt"></i> Forgot Password
  </button>
  
  <button class="btn submits" type="button" onclick="location.href='Login_cust.jsp'">
