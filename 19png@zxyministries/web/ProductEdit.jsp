...
<body>
    ...
    <div class="container fade-in">
        <%
            ...
            Products product = productDAO.getProductById(productId); // Method to fetch product details
            if (product == null) {
        %>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-actions">
                        <button type="button" onclick="location.href='Product_Admin.jsp'" class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="referrer" value="manager">
        ...
        <% } %>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" onclick="location.href='Product_Admin.jsp'" class="btn btn-secondary">
